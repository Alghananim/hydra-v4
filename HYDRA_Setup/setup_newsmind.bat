@echo off
REM ============================================================
REM   This file has been RENAMED to setup_hydra_v3.bat
REM   Please use that file instead. This stub stays for safety.
REM ============================================================
echo This file is deprecated. Use:  setup_hydra_v3.bat
pause
exit /b 0

setlocal EnableDelayedExpansion
chcp 65001 >nul
title NewsMind Trading System - Setup (DEPRECATED)

echo ============================================================
echo   NewsMind Trading System - Local Setup (5 Brains V3)
echo ============================================================
echo.
...
REM ---------- Clone repo ----------
echo [3/6] Cloning newsmind from GitHub...
...
echo        run_newsmind.bat
echo      (or manually: cd "!INSTALL_DIR!" then call .venv\Scripts\activate ^&^& python main_v3.py)
echo.
echo Saving install path for run_newsmind.bat...
> "%~dp0newsmind_path.txt" echo !INSTALL_DIR!
echo   [OK] Saved to %~dp0newsmind_path.txt
echo.
pause
endlocal
