...
class SmartNoteBookV3:
    ...
    # ---------- Engine state (counters that survive restart) ----------
    def save_engine_state(self, key: str, value) -> bool:
        return self.storage.write_engine_state(key, value)

    def load_engine_state(self, key: str, default=None):
        return self.storage.read_engine_state(key, default=default)
